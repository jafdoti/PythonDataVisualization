...
#     return found_countries, not_found
    ...
    plot_keys_lower = [x.lower() for x in plot_countries]
    converter_keys_lower = [y.lower() for y in converter]
    gdp_keys_lower = [z.lower() for z in gdp_countries]
    
#     print("plot_countries keys - ", plot_countries.keys())
#     print("plot_keys_lower - ", plot_keys_lower, "\n")
#     print("converter keys - ", converter.keys())
#     print("converter_keys_lower - ", converter_keys_lower)
#     print("gdp_countries keys - ", gdp_countries.keys())
#     print("gdp_keys_lower - ", gdp_keys_lower)
       
#     for code in plot_countries:
#         print(code)
#         if code in plot_keys_lower:
#             print("plot country code is lower case - ", code)
#             print(plot_keys_lower)
#             for country in gdp_countries:
#                 if country.lower() in gdp_keys_lower and country.lower() in gdp_keys_lower:
